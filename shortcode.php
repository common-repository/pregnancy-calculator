...
<section>
    <div id="mhpcnew-container">
		...
		<div class="mhpc-r-odd mhpc-none">:</div>
  		...
  		<div class="mhpcnew-col-8 mhpc-title mhpc-r-even">
  			<div>
		...
		<div class="mhpc-none mhpc-r-even">:</div>
  		<div class="mhpcnew-col-9 mhpc-data mhpc-r-even">
  			<div>
		...
		<div class="mhpc-r-odd mhpc-none">:</div>
  		...
  		<div class="mhpcnew-col-12 mhpc-title mhpc-r-even">
  			<div>
		...
		<div class="mhpc-none mhpc-r-even">:</div>
  		<div class="mhpcnew-col-13 mhpc-data mhpc-r-even">
  			<div>
		...
		<div class="mhpc-r-odd mhpc-none">:</div>
  		...
  		<div class="mhpcnew-col-16 mhpc-title mhpc-r-even">
  			<div>
			...
			<div class="mhpc-none mhpc-r-even">:</div>
  		<div class="mhpcnew-col-17 mhpc-data mhpc-r-even">
  			<div>
		...
		<div class="mhpc-r-odd mhpc-none">:</div>
  		...
  		<div class="mhpcnew-col-20 mhpc-title mhpc-r-even">
  			<div>
		...
		<div class="mhpc-none mhpc-r-even">:</div>
  		<div class="mhpcnew-col-21 mhpc-data mhpc-r-even">
  			<div>
